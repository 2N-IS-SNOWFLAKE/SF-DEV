...
*/
CREATE OR REPLACE PROCEDURE L0_HELIOS_DEV.PUBLIC.P_2N_LOAD_L0_TRANSACTIONAL_ACCOUNTING()
RETURNS NUMBER(38,0)
LANGUAGE SQL
EXECUTE AS CALLER
AS 
...
MERGE INTO L0_HELIOS.PUBLIC.L0_2N_TRANSACTIONAL_ACCOUNTING USING PJTEMP ON "CISLO_SUBJEKTU" = PJTEMP."cislo_subjektu" AND "CISLO_OBJEKTU" = PJTEMP."cislo_objektu"
